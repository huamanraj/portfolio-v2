...
const projects = [
  ...
  },
  {
    ...
    "title": "BuzzSphere",
    "description": "A real-time chat application with seamless messaging and custom features.",
    ...
    "technologies": ["React", "Appwrite", "Appwrite Realtime", "Tailwind CSS", "Vite"]
  },
  {

    "title": "SnapDrop",
    "description": "A modern and secure file-sharing web app with customizable expiry and short links.",
  ...
  },
  {
    ...
    "description": "A customizable AI-powered quote image creator for social media posts.",
    "image": "https://img.freepik.com/free-photo/industrial-designer-digital-art_23-2151585281.jpg?t=st=1730654190~exp=1730657790~hmac=880ce876a1c45707f69de88b3d95beda4aaa972f12eb119728415c30ec69ffc1&w=1060",
  ...
  },
  {
    ...
    "description": "A backend for recruitment platform AI description generation.",
  ...
  },
  {
    ...
    "description": "A Webpage made in next js and framer motion for a small company Sharma Interiors.",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {projects.map((project) => (
          ...
          >
            ...
            <h2 className="text-lg font-semibold mb-2 pl-1 ">
              {project.title}
            </h2>
            <p className="text-muted-foreground mb-3 pl-1 text-sm leading-relaxed line-clamp-3">
              {project.description}
            </p>
            <div className="flex flex-wrap pl-1 gap-2 mb-3">
